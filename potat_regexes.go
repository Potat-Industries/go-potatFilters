...
var (
	...
	potatNWord           = regexp.MustCompile(`(?i)\b[Nnñ][i1|][ckGgbB6934Q🅱qğĜƃ၅5]+[e3]u?r|n[i1]gg|niga`)
	potatCWord           = regexp.MustCompile(`(?i)\bc+h+i+n+k+s*`)
	potatTWord           = regexp.MustCompile(`(?i)\bt+r+[a4]+n+(i+[e3]+|y+|[e3]+r+)s*`)
	potatFWord           = regexp.MustCompile(`(?i)\bf+[a4@]+(g|qq)+([oei]+t+(r+y+|r+i+[e3]+)?)?s*`)
	potatNonEnglishSlurs = regexp.MustCompile(`(?i)\b(amerykaniec|angol|arabus|asfalt|bambus|brudas|brudaska|Brytol|chachoł|chinol|ciapaty|czarnuch|fryc|gudłaj|helmut|japoniec|kacap|kacapka|kitajec|koszerny|kozojebca|kudłacz|makaroniarz|małpa|Moskal|negatyw|parch|pejsaty|rezun|Rusek|Ruska|skośnooki|syfiara|syfiarz|szkop|szmatogłowy|szuwaks|szwab|szwabka|turas|wietnamiec|żabojad|żółtek|żydek|Żydzisko|zabojad|zoltek|zydek|zydzisko|matoglowy|chachol|szuwak|tura|pidor)\b`)
	...
	potatSelfHarm = regexp.MustCompile(`(?i)(drink (poison|bleach)|slit (y([o0u]+r|o)|ur)|r[a4@]p[e3]\W?(toy|meat|doll|slut|bait|slave|material|[s5$z](l|[^\w\s])([uv]|[^\w\s])[t7]|wh([o0]|[^\w\s])((r|[^\w\s])[e3]|[o0][a@4e3])|hole|face|body|pig)[s5z]?|com+it suicide|end your( own)? life|take your( own)? life|\bp[e3]d[o0]ph[i1]l[e3]\b|\bp[e0]d[o0]\|eat (a|my) (dick|cock|penis)|sieg heil|heil hitler)`)

	potatSexualHarassment1 = regexp.MustCompile(`(?i)pull the [^\s.]+( dam\w*| fuck\S+)? trigger(?: (?:on(?: (?:yo)?ur\W?self))?)?|blows? (\w+\W+(?:\.)){1,4}(?:brains? out)?|play in (some )?traffic|(get|be) raped(?: (?:with| on\b))?(?: (?:can be raped|meant to be raped))?|r[a4@]p(?:[e3][sd]?\b|[i1!¡jl]ng) (her|him|the[my]|them)|r[a4@]p(?:[e3][sd]?\b|[i1!¡jl]ng)\b.{0,120}?\b(?:(?:1[0-7]|[1-9])\s?(?:yo|yr|y/o|year ?old)|(?:minor|kid|child|teen|underage))\b|throats? (cut|ripped|slit)|pedo|pedobear|(lick|eat|suck|gobble) (my|your|his|her|their|our) (cock|dick|balls|cum|kok|coc)|^get (cancer|a(?: \w+)? tumor|AIDS|HIV|covid\w*|coronavirus|sick)|\b(suck|lick|gobble|consume|eat)\b.*?\b(my|these)\b.*?\b(cock|penis|dick|balls|nuts)|((show|flash|expose) (you|your|those|them) (tits|boobs|breasts|ass|cock|pussy|vagina|crotch))`)
